...
Ётот проект Ч одна из частей финального проекта на курсе "»нденер машинного обучени€" от Karpov.Courses. ¬ нем реализован сервис персональных рекомендаци€ постов дл€ пользователей.
